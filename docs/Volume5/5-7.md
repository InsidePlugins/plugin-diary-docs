...
有鉴于原作者 ThatRarityEG 道席常用 Paper API 编程，并在 EX-2-1 中建议读者将 Paper 服务端作为依赖，必须对这些“过时”方法的替代品作论述。第五卷原先只有七节，5-7 为“自定义进度”，现于 5-6 和 5-7 之间插入一节 Adventure API 教程，将“自定义进度”移至 5-8 。之所以不将新写的教程附在卷末，是因为“自定义进度”这一节有结束语，对第五卷内容作了总结，必须置尾。
